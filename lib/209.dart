...
class _CalendarPageState extends State<CalendarPage> {
  Map<int, Color> dateColors = {
    1: Colors.red, 2: Colors.green, 3: Colors.yellow, 4: Colors.yellow, 5: Colors.red, 6: Colors.green, 7: Colors.green,
    8: Colors.red, 9: Colors.green, 10: Colors.yellow, 11: Colors.yellow, 12: Colors.blue, 13: Colors.green, 14: Colors.green,
    15: Colors.red, 16: Colors.green, 17: Colors.yellow, 18: Colors.purple, 19: Colors.red, 20: Colors.green, 21: Colors.green,
    22: Colors.red, 23: Colors.yellow, 24: Colors.yellow, 25: Colors.yellow, 26: Colors.blue, 27: Colors.green, 28: Colors.green,
    29: Colors.red, 30: Colors.green,
  };
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            SizedBox(height: 20),
            Text("April 2025", style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold)),
            SizedBox(height: 10),
            Wrap(
              spacing: 8.0,
              runSpacing: 8.0,
                ...
                return GestureDetector(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: selectedDay == day ? Colors.purple : dateColors[day] ?? Colors.grey,
            ...
            SizedBox(height: 20),
            Text(selectedDate, style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
            Padding(
